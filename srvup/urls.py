...
urlpatterns = patterns('',
    ...
    url(r'^terms/$', TemplateView.as_view(template_name='company/terms.html'), name='terms'),
    url(r'^$', 'srvup.views.home', name='home'),
    url(r'^projects/$', 'videos.views.category_list', name='projects'),
    url(r'^tips/$', 'srvup.views.tips', name='tips'),
    url(r'^test/info$', 'srvup.views.test_info', name='test_info'),
...
urlpatterns += patterns('accounts.views',
    ...
    url(r'^account/created/$', 'account_created', name='account_created'),
)
